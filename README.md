...
Make sure to **shower** and `install Python3` along with `adding it to your PATH` Environment variables when installing it. You can install it [***__here!__***](https://www.python.org/downloads)
